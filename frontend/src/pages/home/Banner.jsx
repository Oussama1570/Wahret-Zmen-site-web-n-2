  ...
  return (
    <div className='banner-container'>
      ...
      <div className='banner-text'>
        ...
        <p>Wahretz Zmen is a unique boutique of traditional Tunisian clothing located in El Aswak, Tunis, Essouf Street.

           The boutique offers a carefully selected selection of authentic Tunisian clothing, including the iconic Jebba,
           famous for its intricate craftsmanship and cultural significance.</p>
